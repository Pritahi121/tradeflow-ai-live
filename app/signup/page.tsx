          ...
          <CardContent>
            ...
            <div className="mt-6">
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <Button variant="outline" disabled={loading || !agreeToTerms} onClick={handleGoogleSignUp}>
                  {loading ? (
                ...
                <Button variant="outline" disabled={loading || !agreeToTerms} onClick={handleTwitterSignUp}>
                  {loading ? (
                    <Loader2 className="w-4 h-4 mr-2 animate-spin" />
                  ) : (
